...
export const OBSTACLE_VISUAL = {
  ...
  barrel1: { width: 80 * OBSTACLE_SCALE, height: 70 * OBSTACLE_SCALE },
  barrel2: { width: 80 * OBSTACLE_SCALE, height: 70 * OBSTACLE_SCALE },
...
export const OBSTACLE_SIZES = {
  ...
  barrel1: { width: 60, height: 60 },
  barrel2: { width: 60, height: 60 },
